...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="GPIC Core configuration.lvclass" Type="LVClass" URL="../module/configuration/GPIC Core configuration.lvclass"/>
		<Item Name="GPIC Core editor node.lvclass" Type="LVClass" URL="../editor node/GPIC Core editor node.lvclass"/>
		<Item Name="GPIC Core runtime.lvclass" Type="LVClass" URL="../module/execution/GPIC Core runtime.lvclass"/>
		<Item Name="GPIC Core tests.lvlib" Type="Library" URL="../Test/GPIC Core tests.lvlib"/>
